module Zermelo
  module Associations
    class AssociationData
      ...
      attr_accessor :name, :type_klass, :inverse, :sort_key, :sort_order,
        :callbacks

      def initialize(opts = {})
        [:name, :type_klass, :inverse, :sort_key, :sort_order, :callbacks,
         :data_klass_name, :related_klass_names].each do |a|
