...
describe Sandstorm::Backends::RedisBackend, :redis => true do
  ...
  context 'lock' do
    ...
    it "locks access to class-level data" do
      ...
      slock = Sandstorm::Locks::RedisLock.new(Sandstorm::RedisLockExample)
      locked = slock.lock
    ...
    it "locks access to class-level data from two classes" do
      ...
      slock = Sandstorm::Locks::RedisLock.new(Sandstorm::RedisLockExample, Sandstorm::AnotherExample)
      locked = slock.lock
      expect(locked).to be_truthy
