...
describe Zermelo::Associations::Singular do # rubocop:disable Metrics/BlockLength
  context 'has_one' do # rubocop:disable Metrics/BlockLength
    ...
    context 'redis', redis: true, has_one: true do # rubocop:disable Metrics/BlockLength
      ...
      it 'sets and retrieves a record via a has_one association' do
        ...
        expect(redis.hgetall("#{ck}:22:assocs:belongs_to")).
          to eq('parent_id' => '8')
